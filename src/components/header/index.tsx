...
const Header = ({ isHomePage }: { isHomePage: boolean }) => {
  return (
    <header
      className={`py-4 top-0 z-50 w-full ${
        isHomePage ? "fixed bg-transparent" : "bg-main sticky"
      }`}
    >
      <div
        className={`${
